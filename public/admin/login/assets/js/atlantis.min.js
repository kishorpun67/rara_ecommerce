...
$(".nav-search .input-group > input").focus(function(s) { $(this).parents().eq(2).addClass("focus") }).blur(function(s) { $(this).parents().eq(2).removeClass("focus") }), $(function() { $('[data-toggle="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover(), layoutsColors(), customBackgroundColor() }), $(document).ready(function() {
    $(".btn-refresh-card").on("click", function() {
        var s = $(this).parents(".card");
        s.length && (s.addClass("is-loading"), setTimeout(function() { s.removeClass("is-loading") }, 3e3))
    });
    ...
    var c = !1,
        ...
        b = 0;
    if (!c) {
        (C = $(".sidenav-toggler")).on("click", function() { 1 == u ? ($("html").removeClass("nav_open"), C.removeClass("toggled"), u = 0) : ($("html").addClass("nav_open"), C.addClass("toggled"), u = 1) }), c = !0
    }
    if (!h) {
        var C = $(".quick-sidebar-toggler");
        C.on("click", function() { 1 == u ? ($("html").removeClass("quick_sidebar_open"), $(".quick-sidebar-overlay").remove(), C.removeClass("toggled"), h = 0) : ($("html").addClass("quick_sidebar_open"), C.addClass("toggled"), $('<div class="quick-sidebar-overlay"></div>').insertAfter(".quick-sidebar"), h = 1) }), $(".wrapper").mouseup(function(s) {
            var a = $(".quick-sidebar");
        ...
        }), $(".close-quick-sidebar").on("click", function() { $("html").removeClass("quick_sidebar_open"), $(".quick-sidebar-toggler").removeClass("toggled"), $(".quick-sidebar-overlay").remove(), h = 0 }), h = !0
    }
    if (!d) {
        var k = $(".topbar-toggler");
        k.on("click", function() { 1 == m ? ($("html").removeClass("topbar_open"), k.removeClass("toggled"), m = 0) : ($("html").addClass("topbar_open"), k.addClass("toggled"), m = 1) }), d = !0
    }
    if (!g) {
