            ...
            <div class="pulse animatable">
              <div class="breadCrumbNav">
                <div class="container breadcrumb-container">
                  <h1 class="breadCrumb_title"> catalog</h1>
                  <div class="breadcumb-inner">
                    <ul>
                      <li><a href="{{route('home')}}" class="breadCrumb_link">Home</a></li>
                      @if ($countCategoryDetalis->parent_id == 0)
                        <li><i class="fa-solid fa-arrow-right-long"></i></li>
                        <li><a href="{{route('products', $countCategoryDetalis->url)}}"><span>{{$countCategoryDetalis->category_name}}</span></a></li>
                      @else
                          @if (!empty($countCategoryDetalis->parentcategory->id))
                            <li><i class="fa-solid fa-arrow-right-long"></i></li>
                            <li><a href="{{route('products',$countCategoryDetalis->parentcategory->url)}}"><span>{{$countCategoryDetalis->parentcategory->category_name}}</span></a></li>
                            <li><i class="fa-solid fa-arrow-right-long"></i></li>
                            <li><a href="{{route('products',$countCategoryDetalis->url)}}"><span>{{$countCategoryDetalis->category_name}}</span></a></li>
                          @endif
                      @endif
