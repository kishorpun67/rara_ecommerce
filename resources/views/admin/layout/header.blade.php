							...
							<li>
								<div class="user-box">
									...
									<div class="u-text">
										...
										<p class="text-muted">{{auth('admin')->user()->email}}</p><a href="profile.html" class="btn btn-xs btn-secondary btn-sm">View Profile</a>
									</div>
								</div>
							</li>
							<li>
								...
								<a class="dropdown-item" href="{{route('admin.logout')}}"><p><i class="fa fa-sign-out-alt" aria-hidden="true"></i> Logout
								</p>
								</a>
							</li>
						</div>
